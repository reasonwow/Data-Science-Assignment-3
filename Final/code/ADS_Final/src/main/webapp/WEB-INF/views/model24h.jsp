		...
		<!-- Header -->
			<div id="header2">
				<div class="container">
					...
					<!-- Logo -->
						<h1><a href="#" id="logo">Group 1 Final Project</a></h1>
						...
						<nav id="nav">
							<ul>
								...
								<li>
									<a href="">Analytics</a>
									<ul>
										<li><a href="dummyModel.htm">Analytics for Uber </a></li>
										<li><a href="dummy24.htm">Uber Driver Hot Spot</a></li>
										<li><a href="#"> </a></li>
										
										
									</ul>
								</li>
								<li><a href="dummyModel.htm">Dispatch Base Report</a></li>								
								<li><a href="https://public.tableau.com/profile/publish/bg/Story1#!/publish-confirm">Visualization</a></li>
							</ul>
						</nav>
					...
					<!-- Banner -->
						<div id="banner">
							<div class="container">
								<section>
									<header class="major">
										<h2>Uber NYC Analytics</h2>
										<!-- <span class="byline"> Mining the Database From Uber  <br/>1. date, zone, trips<br/>
										2. by days/hours <br/>
										3. by base</span> -->
									</header>
		...
		<!-- Featured -->
			<div class="wrapper style2">
				<section class="container">
					<header class="major">
						<h2>Find The Trace of Spot</h2>
						<span class="byline">Predict The Total Trips of Every 3 Hours in Specific Area</span>
					</header>
					...
					<div class="container">
						...
						<section class="4u" style="margin: 0 auto">
							...
							<p>Find The Hottest Hour To Work</p>
							<form action="hotSpot24.htm" method ="post">
							<div class="controls">
