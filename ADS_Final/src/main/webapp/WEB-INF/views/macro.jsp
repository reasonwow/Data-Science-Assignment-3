		...
		<div class="row-fluid">
			<div class="span12">
				...
				<form class="form-horizontal" method="post" action='addInput.htm' name="inputForm" id="inputForm">
					...
					<!-- AGASSIZ, ArtsJan, Blackstone Jan, BlackstoneJul, BLDG, BOSTN LATIN ACDMY, 
					BOSTON LATIN, BOSTON LATIN ANNX, CAMPBELL, CENTRAL KITCHEN, CHARLESTOWN HIGH, 
					CLEVELAND NEW, CLEVELAND OLD, COPLEY SQUARE, COURT ST, CURLEY CMTY CTR, DEVER,
					 DISTRICT 1 AREA A, DORCHESTER HIGH, DUDLEY SQ, EEC, EECEASTBOSTON, ENGLISH HIGH,
					  HARVARD ST, HEADQUARTERS, HEMENWAY, HYDE PARK HIGH, HYDE PARK2014, JACKSON MANN,
					   JAMES F CONDON, JAMES W HENNIGAN, JERIMAH BURKE, JOSEPH LEE, JOSIAH QUINCY, LILLA FREDRICK,
					    MATTAHUNT, MATTAPAN, MGMT, MGMT_1481TREMONT_TOBIN COMMUNITY CENTER, MILDRED SCHOOL,
					     MISSION HIGH, MURPHY, NATHAN HALE, ORCHARDGARDENS, PARIS ST COMM CT, RICHARD J MURPHY, 
					     STATION 11 AREA C, STRATTON, TROTTER, W H OHRENBERGER, WEST ROXBURY, WILLIAM H TAFT,
					      WILLIAM RUSSELL, WM H KENT -->
					<div class="control-group">
	    ...
	    MATTAHUNT, MATTAPAN, MGMT, MGMT_1481TREMONT_TOBIN COMMUNITY CENTER, MILDRED SCHOOL,
	     ...
	     STATION 11 AREA C, STRATTON, TROTTER, W H OHRENBERGER, WEST ROXBURY, WILLIAM H TAFT,
	      WILLIAM RUSSELL, WM H KENT -->
							...
							<!-- <input type="text" name="building" id="building" title="Building" value=""> -->
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
						<!-- Fog, Fog-Rain, Fog-Rain-Snow, Fog-Rain-Thunderstorm, Fog-Snow, Rain, Rain-Snow, Rain-Thunderstorm, Snow, -->
