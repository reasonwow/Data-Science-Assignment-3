				...
				<section class="container">
					...
					<div class="container">
						...
						<section class="4u" style="margin: 0 auto">
							...
							<p>Dispatch Your Car To The Hot Spot</p>
							...
							<%-- <div class="controls">
								...
								<input type = "text" name ="date" placeholder="Enter the Date in 5 Days">
								Work Day or Not? <select name="workDay" id="workDay">
